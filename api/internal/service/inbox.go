...
type InboxRepository interface {
	...
	List(ctx context.Context, userID uuid.UUID, excludeCompleted bool, search string, projectKeys []string, workItemID *uuid.UUID, cursor *uuid.UUID, limit int) (*model.InboxItemList, error)
...
func (s *InboxService) List(ctx context.Context, info *model.AuthInfo, excludeCompleted bool, search string, projectKeys []string, workItemID *uuid.UUID, cursor *uuid.UUID, limit int) (*model.InboxItemList, error) {
	list, err := s.inbox.List(ctx, info.UserID, excludeCompleted, search, projectKeys, workItemID, cursor, limit)
	if err != nil {
