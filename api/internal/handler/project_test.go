...
// noopInboxRepo is a minimal service.InboxRepository for project handler tests.
...
// noopWatcherRepo is a minimal service.WatcherRepository for project handler tests.
