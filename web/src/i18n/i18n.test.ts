...
const SAME_VALUE_ALLOWED = new Set([
  ...
  'common.autoRefresh5s',
  'common.autoRefresh10s',
  'common.autoRefresh30s',
  'common.autoRefresh1m',
  'common.autoRefresh5m',
  ...
  // Portal: "Status", "Priority" are cognates in many languages
  'portal.status',
  'portal.priority',
  'portal.category',
  'portal.queue',
