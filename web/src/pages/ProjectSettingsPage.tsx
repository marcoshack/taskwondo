  ...
  return (
    <div className="max-w-2xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Manage your project settings.</p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-4">
        ...
        {saveSuccess && <p className="text-sm text-green-600">Project updated successfully.</p>}
      ...
      {/* Danger Zone */}
      <div className="border border-red-300 rounded-lg mt-8">
        <div className="px-4 py-3 border-b border-red-300">
