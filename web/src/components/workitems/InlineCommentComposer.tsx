...
export function InlineCommentComposer({
  ...
  return (
    <div
      className="w-80 max-w-[90vw] rounded-md border border-[var(--primary-border)]  bg-[var(--surface)] shadow-lg p-3"
    ...
    >
      ...
      <blockquote className="text-xs text-[var(--foreground-secondary)] border-l-2 border-[var(--primary-border)]  pl-2 mb-2 line-clamp-3 whitespace-pre-wrap break-words">
        {selectedText}
      </blockquote>
      <textarea
        ref={ref}
