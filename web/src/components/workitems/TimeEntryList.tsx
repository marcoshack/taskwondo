          ...
          <div className="flex items-center justify-between gap-2 mb-1">
            ...
            {user && entry.user_id === user.id && !readOnly && editingId !== entry.id && (
              <div className="flex items-center shrink-0">
                ...
                <button
                  className="group/del relative inline-flex items-center justify-center w-7 h-7 rounded-md text-red-400 hover:text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-900/30 transition-colors [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover/entry:opacity-100"
